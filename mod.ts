...
slash.handle("invite", (d) => {
  return d.reply(
    `• [Click here to invite the bot to your server.](<https://discord.com/oauth2/authorize?client_id=894186849914982430&permissions=2147552257&scope=applications.commands%20bot>)\n` +
